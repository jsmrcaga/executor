...
class Database {
	...
	connect(options = null) {
		...
		let { url, protocol='mongodb', endpoint, username, password, port=27131, database, timeout, query='', ...other_options } = options;
		...
		let connection_url = url || (`${protocol}://${username}:${password}@${endpoint}${protocol
