	...
	class Model {
		...
		static get(selector={}, options={}) {
			...
			return cursor.count().then(count => {
				...
				return this.fromJSON(objects)[0];
			});
		}
		 ...
		 */
		save(options = {}) {
			return dbUtils.update(this.constructor.collection(), this, options);
		}
		 ...
		 */
		delete(options = {}) {
			return dbUtils.delete(this.constructor.collection(), this, options);
		}
